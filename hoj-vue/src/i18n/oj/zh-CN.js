export const m = {
  ...
  Error:'错误',
  Success:'成功',
  No_Access_There_is_no_open_discussion_area_on_the_website: '禁止访问：当前网站未开启论坛区！',
  No_Access_There_is_no_open_group_discussion_area_on_the_website: '禁止访问：当前网站未开启团队论坛区！',
  ...
  Edit: '编辑',
  Delete: '删除',
  Post_discussion: '发布一个帖子~',
  Post_problem_discussion: '发布题解',
  General_discussion: '公共论坛区',
  Return: '返回',
  Category: '分类',
  Discussion_title: '标题',
  Discussion_Desc: '描述',
  Associated_Problem:'帖子关联的题目ID',
  Associated_Problem_Tips:'帖子关联的题目ID, 例如 P1000',
  Discussion_Category: '分类',
  Discussion_top: '是否置顶',
  Discussion_content: '内容',
  Create_Discussion: '创建',
  Edit_Discussion: '编辑',
  Delete_Discussion_Tips: '此操作将删除帖子，包括相关的评论和回复。你要继续吗？',
  ...
  Full_Stack_Secondary_Development_Contributor:'全栈二次开发贡献者',
  Distributed: '分布式',
  ...
  Action_Like_Post: '赞了我的帖子',
  Action_Discuss: '评论了我的帖子',
  Action_Reply: '回复了我的评论',
  From_Discussion_Post: '来自帖子',
  ...
  Back_To_Admin_Training_List:'返回题单管理列表',
  Back_To_Training_List:'返回题单列表',
  Back_Admin_Training_Problem_List:'返回题单题目管理列表',
  ...
  NavBar_Chat: '私聊',
  Chat: '私聊',
  Chat_No_Contacts: '暂无聊天联系人',
  Chat_Select_Contact: '请选择联系人开始聊天',
  Chat_Placeholder: '输入消息，回车发送，Shift+回车换行',
  Chat_Send: '发送',
  Chat_No_Messages: '暂无聊天记录',
  Chat_Start_Conversation: '在用户主页点击"发送私信"开始对话',
  Chat_Send_Message: '发送私信',

  // PK对战模块
  PK: 'PK对战',
  PK_Invite: '发起PK',
  PK_Invite_Title: '邀请对手进行PK对战',
  PK_Search_User: '搜索用户',
  PK_Search_Placeholder: '输入用户名或昵称搜索',
  PK_Invite_Send: '发送邀请',
  PK_Invite_Sent: 'PK邀请已发送，等待对方响应',
  PK_Invite_Received: '您收到了一个PK邀请',
  PK_Invite_From: '来自',
  PK_Invite_Problem: '题目',
  PK_Accept: '接受邀请',
  PK_Dismiss: '不再提示',
  PK_Reject: '拒绝',
  PK_Waiting: '等待对手接受邀请...',
  PK_Countdown: '剩余时间',
  PK_Surrender: '认输',
  PK_Surrender_Tips: '确认认输？认输后对手将直接获胜。',
  PK_Pending_Invites: '待处理的PK邀请',
  PK_Invite_Sent_Text: '你向',
  PK_Invite_Received_Text: '向你发起了PK邀请',
  PK_Invite_Cancel_Btn: '取消邀请',
  PK_You_Win: '你赢了！',
  PK_You_Lose: '你输了！',
  PK_Draw: '平局！',
  PK_Score: 'PK积分',
  PK_Score_Change: '积分变化',
  PK_Match_Ended: '对战已结束',
  PK_No_Paste: 'PK模式下不允许粘贴代码，请手动输入',
  PK_Already_In: '你或对手已在进行其他PK对战',
  PK_Cannot_Self: '不能与自己进行PK对战',
  PK_Result: '对战结果',
  PK_First_To_AC: '率先AC获胜',
  PK_History: 'PK历史',
  PK_Total: '总场次',
  PK_Wins: '胜',
  PK_Losses: '负',
  PK_Draws: '平',
  PK_Time_Up: '时间到！',
  PK_Opponent_Surrendered: '对手已认输',
  PK_You_Surrendered: '你已认输',
  PK_Back_To_Problem: '返回题目',
  PK_Play_Again: '再来一局',
  PK_No_Active_Match: '当前没有进行中的PK对战',
  PK_Invite_Timeout: 'PK邀请已过期',
  PK_History_Title: '我的PK记录',
  PK_History_Empty: '还没有PK记录，去题目页发起一场对战吧！',
  PK_Result_Win: '胜利',
  PK_Result_Lose: '失败',
  PK_Result_Draw: '平局',
  PK_Result_Surrendered: '已认输',
  PK_Result_OpponentSurrendered: '对手认输',
  PK_Status_Finished: '已结束',
  PK_Status_Rejected: '已拒绝',
  PK_Status_Cancelled: '已取消',
  PK_Status_Draw: '平局',

  // 作业模块
  Assignment_Title: '作业',
  Assignment_My_List: '我的作业',
  Assignment_Status: '状态',
  Assignment_Required: '必做',
  Assignment_Optional: '选做',
  Assignment_Completed: '已完成',
  Assignment_Unfinished: '未完成',
  Assignment_Progress: '完成进度',
  Assignment_Problem_Count: '题目数',
  Assignment_Deadline: '截止时间',
  Assignment_Start_Time: '开始时间',
  Assignment_Not_Started: '未开始',
  Assignment_Running: '进行中',
  Assignment_Ended: '已结束',
  Assignment_Empty: '暂无布置给我的作业',
  Assignment_Detail: '作业详情',
  Assignment_Problem_List: '题目列表',
  Assignment_AC: '已通过',
  Assignment_Not_AC: '未通过',
  Assignment_Creator: '布置人',
  Assignment_Required_Badge: '必做未完成',
}
