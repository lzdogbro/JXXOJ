export const m = {
  ...
  // 과제 모듈
  Assignment_Title: '과제',
  Assignment_My_List: '내 과제',
  Assignment_Status: '상태',
  Assignment_Required: '필수',
  Assignment_Optional: '선택',
  Assignment_Completed: '완료',
  Assignment_Unfinished: '미완료',
  Assignment_Progress: '진행률',
  Assignment_Problem_Count: '문제 수',
  Assignment_Deadline: '마감 시간',
  Assignment_Start_Time: '시작 시간',
  Assignment_Not_Started: '시작 전',
  Assignment_Running: '진행 중',
  Assignment_Ended: '종료됨',
  Assignment_Empty: '나에게 배정된 과제가 없습니다',
  Assignment_Detail: '과제 상세',
  Assignment_Problem_List: '문제 목록',
  Assignment_AC: '통과',
  Assignment_Not_AC: '미통과',
  Assignment_Creator: '출제자',
  Assignment_Required_Badge: '필수 미완료',
}