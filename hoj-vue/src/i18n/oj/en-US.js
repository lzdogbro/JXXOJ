export const m = {
  ...
  Full_Stack_Secondary_Development_Contributor: 'Full-Stack Secondary Development Contributor',
  ...
  NavBar_Chat: 'Chat',
  Chat: 'Chat',
  Chat_No_Contacts: 'No contacts',
  Chat_Select_Contact: 'Select a contact to start chatting',
  Chat_Placeholder: 'Type a message — Enter to send, Shift+Enter for a new line',
  Chat_Send: 'Send',
  Chat_No_Messages: 'No messages',
  Chat_Start_Conversation: 'Click "Send Message" on user profile to start a conversation',
  Chat_Send_Message: 'Send Message',

  // PK Battle
  PK: 'PK Battle',
  PK_Invite: 'Invite to PK',
  PK_Invite_Title: 'Invite Opponent for PK Battle',
  PK_Search_User: 'Search User',
  PK_Search_Placeholder: 'Search by username or nickname',
  PK_Invite_Send: 'Send Invite',
  PK_Invite_Sent: 'PK invitation sent, waiting for response',
  PK_Invite_Received: 'You have received a PK invitation',
  PK_Invite_From: 'From',
  PK_Invite_Problem: 'Problem',
  PK_Accept: 'Accept',
  PK_Dismiss: 'Dismiss',
  PK_Reject: 'Reject',
  PK_Waiting: 'Waiting for opponent to accept...',
  PK_Countdown: 'Remaining Time',
  PK_Surrender: 'Surrender',
  PK_Surrender_Tips: 'Are you sure you want to surrender? Your opponent will win immediately.',
  PK_Pending_Invites: 'Pending PK Invites',
  PK_Invite_Sent_Text: 'You invited',
  PK_Invite_Received_Text: 'invited you to a PK match',
  PK_Invite_Cancel_Btn: 'Cancel',
  PK_You_Win: 'You Win!',
  PK_You_Lose: 'You Lose!',
  PK_Draw: 'Draw!',
  PK_Score: 'PK Score',
  PK_Score_Change: 'Score Change',
  PK_Match_Ended: 'Match Ended',
  PK_No_Paste: 'Paste is disabled in PK mode. Please type manually.',
  PK_Already_In: 'You or your opponent is already in another PK match',
  PK_Cannot_Self: 'Cannot PK with yourself',
  PK_Result: 'Battle Result',
  PK_First_To_AC: 'First to AC wins',
  PK_History: 'PK History',
  PK_Total: 'Total',
  PK_Wins: 'Wins',
  PK_Losses: 'Losses',
  PK_Draws: 'Draws',
  PK_Time_Up: 'Time is up!',
  PK_Opponent_Surrendered: 'Opponent has surrendered',
  PK_You_Surrendered: 'You have surrendered',
  PK_Back_To_Problem: 'Back to Problem',
  PK_Play_Again: 'Play Again',
  PK_No_Active_Match: 'No active PK match',
  PK_Invite_Timeout: 'PK invitation has expired',
  PK_History_Title: 'My PK Records',
  PK_History_Empty: 'No PK records yet. Go to a problem page to start a battle!',
  PK_Result_Win: 'Victory',
  PK_Result_Lose: 'Defeat',
  PK_Result_Draw: 'Draw',
  PK_Result_Surrendered: 'Surrendered',
  PK_Result_OpponentSurrendered: 'Opponent Surrendered',
  PK_Status_Finished: 'Finished',
  PK_Status_Rejected: 'Rejected',
  PK_Status_Cancelled: 'Cancelled',
  PK_Status_Draw: 'Draw',

  // Assignment module
  Assignment_Title: 'Assignment',
  Assignment_My_List: 'My Assignments',
  Assignment_Status: 'Status',
  Assignment_Required: 'Required',
  Assignment_Optional: 'Optional',
  Assignment_Completed: 'Completed',
  Assignment_Unfinished: 'Unfinished',
  Assignment_Progress: 'Progress',
  Assignment_Problem_Count: 'Problems',
  Assignment_Deadline: 'Deadline',
  Assignment_Start_Time: 'Start Time',
  Assignment_Not_Started: 'Not Started',
  Assignment_Running: 'Running',
  Assignment_Ended: 'Ended',
  Assignment_Empty: 'No assignments assigned to you',
  Assignment_Detail: 'Assignment Details',
  Assignment_Problem_List: 'Problem List',
  Assignment_AC: 'Accepted',
  Assignment_Not_AC: 'Not Accepted',
  Assignment_Creator: 'Creator',
  Assignment_Required_Badge: 'Required & Unfinished',
}
