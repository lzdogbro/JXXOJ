export const m = {
  ...
  Delete_Contest_Tips: '此操作将删除该比赛以及比赛的提交、帖子、公告、记录等数据, 是否继续?',
  ...
  Discussion_ID: '帖子ID',
  Top: '置顶',
  Discussion_Report: '论坛举报',
  Reporter: '举报者',
  Report_Time: '举报时间',
  View_Report_content: '查看举报内容',
  View_Discussion: '查看帖子详情',
  Content: '内容',
  Report_Content: '举报内容',
  The_number_of_discussions_selected_cannot_be_empty: '勾选的帖子不能为空',
  ...
  Assignment_Admin: '作业管理',
  Assignment_List: '作业列表',
  Create_Assignment: '创建作业',
  Edit_Assignment: '编辑作业',
  Student_Group_Admin: '学生组管理',
  Assignment_Description: '作业描述',
  Assignment_Display_ID: '展示编号',
  Assignment_Student_Group: '学生组',
  Assignment_Extra_User: '额外学生',
  Assignment_Exclude_User: '排除学生',
  Assignment_Completion_Stats: '完成统计',
  Assignment_Add_Problem: '添加题目',
  Assignment_Problem_Number: '题号',
  Assignment_Draft: '草稿',
  Assignment_Published: '已发布',
  Assignment_Publish: '发布',
  Assignment_Save_Draft: '保存草稿',
  Assignment_Save_Publish: '保存并发布',
  Assignment_Extend: '延长截止',
  Assignment_Accepted_Count: '已通过题数',
  Assignment_Finish_Time: '完成时间',
  Assignment_Delete_Tips: '确定删除该作业吗？',
  Assignment_Publish_Tips: '确定发布该作业吗？',
  Assignment_Extend_Tips: '请选择新的截止时间',
  Assignment_Time_Check: '开始时间必须早于结束时间',
  Assignment_Problem_Empty: '请至少添加一道题目',
  Assignment_No_Target: '请至少选择一个学生组或填写一个学生',
  Assignment_Extra_User_Placeholder: '输入学生用户名，回车添加',
  Assignment_Exclude_User_Placeholder: '选择要排除的学生',
  Student_Group_Name: '组名称',
  Student_Group_Description: '组描述',
  Student_Group_Member_Count: '成员数',
  Student_Group_Members: '成员管理',
  Student_Group_Add: '新增学生组',
  Student_Group_Edit: '编辑学生组',
  Student_Group_Delete_Tips: '确定删除该学生组吗？',
  Student_Group_Add_Member: '添加成员',
  Student_Group_Remove_Tips: '确定移除该成员吗？',
  Student_Group_Empty: '暂无学生组',
  Difficulty: '难度',
}
