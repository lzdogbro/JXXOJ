export const m = {
  ...
  Assignment_Admin: '課題管理',
  Assignment_List: '課題一覧',
  Create_Assignment: '課題を作成',
  Edit_Assignment: '課題を編集',
  Student_Group_Admin: '学生グループ管理',
  Assignment_Description: '課題の説明',
  Assignment_Display_ID: '表示番号',
  Assignment_Student_Group: '学生グループ',
  Assignment_Extra_User: '追加学生',
  Assignment_Exclude_User: '除外学生',
  Assignment_Completion_Stats: '完了統計',
  Assignment_Add_Problem: '問題を追加',
  Assignment_Problem_Number: '問題番号',
  Assignment_Draft: '下書き',
  Assignment_Published: '公開済み',
  Assignment_Publish: '公開',
  Assignment_Save_Draft: '下書き保存',
  Assignment_Save_Publish: '保存して公開',
  Assignment_Extend: '締切延長',
  Assignment_Accepted_Count: 'AC問題数',
  Assignment_Finish_Time: '完了時間',
  Assignment_Delete_Tips: 'この課題を削除しますか？',
  Assignment_Publish_Tips: 'この課題を公開しますか？',
  Assignment_Extend_Tips: '新しい締切を選択してください',
  Assignment_Time_Check: '開始時間は終了時間より前でなければなりません',
  Assignment_Problem_Empty: '問題を少なくとも1つ追加してください',
  Assignment_No_Target: '学生グループを1つ選択するか学生を入力してください',
  Assignment_Extra_User_Placeholder: '学生ユーザー名を入力してEnter',
  Assignment_Exclude_User_Placeholder: '除外する学生を選択',
  Student_Group_Name: 'グループ名',
  Student_Group_Description: 'グループの説明',
  Student_Group_Member_Count: 'メンバー数',
  Student_Group_Members: 'メンバー管理',
  Student_Group_Add: '学生グループを追加',
  Student_Group_Edit: '学生グループを編集',
  Student_Group_Delete_Tips: 'この学生グループを削除しますか？',
  Student_Group_Add_Member: 'メンバーを追加',
  Student_Group_Remove_Tips: 'このメンバーを削除しますか？',
  Student_Group_Empty: '学生グループはまだありません',
  Difficulty: '難易度',
}