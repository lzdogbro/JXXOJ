export const m = {
  ...
  Assignment_Admin: '과제 관리',
  Assignment_List: '과제 목록',
  Create_Assignment: '과제 생성',
  Edit_Assignment: '과제 편집',
  Student_Group_Admin: '학생 그룹 관리',
  Assignment_Description: '과제 설명',
  Assignment_Display_ID: '표시 번호',
  Assignment_Student_Group: '학생 그룹',
  Assignment_Extra_User: '추가 학생',
  Assignment_Exclude_User: '제외 학생',
  Assignment_Completion_Stats: '완료 통계',
  Assignment_Add_Problem: '문제 추가',
  Assignment_Problem_Number: '문제 번호',
  Assignment_Draft: '초안',
  Assignment_Published: '게시됨',
  Assignment_Publish: '게시',
  Assignment_Save_Draft: '초안 저장',
  Assignment_Save_Publish: '저장 후 게시',
  Assignment_Extend: '마감 연장',
  Assignment_Accepted_Count: '통과 문제 수',
  Assignment_Finish_Time: '완료 시간',
  Assignment_Delete_Tips: '이 과제를 삭제하시겠습니까?',
  Assignment_Publish_Tips: '이 과제를 게시하시겠습니까?',
  Assignment_Extend_Tips: '새 마감 시간을 선택하세요',
  Assignment_Time_Check: '시작 시간은 종료 시간보다 빨라야 합니다',
  Assignment_Problem_Empty: '문제를 하나 이상 추가하세요',
  Assignment_No_Target: '학생 그룹을 하나 선택하거나 학생을 입력하세요',
  Assignment_Extra_User_Placeholder: '학생 사용자명 입력 후 Enter',
  Assignment_Exclude_User_Placeholder: '제외할 학생 선택',
  Student_Group_Name: '그룹 이름',
  Student_Group_Description: '그룹 설명',
  Student_Group_Member_Count: '회원 수',
  Student_Group_Members: '회원 관리',
  Student_Group_Add: '학생 그룹 추가',
  Student_Group_Edit: '학생 그룹 편집',
  Student_Group_Delete_Tips: '이 학생 그룹을 삭제하시겠습니까?',
  Student_Group_Add_Member: '회원 추가',
  Student_Group_Remove_Tips: '이 회원을 삭제하시겠습니까?',
  Student_Group_Empty: '학생 그룹이 없습니다',
  Difficulty: '난이도',
}