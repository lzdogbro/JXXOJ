export const m = {
  ...
  Student_Group_Admin: 'Student Group Admin',
  Assignment_Description: 'Description',
  Assignment_Display_ID: 'Display ID',
  Assignment_Student_Group: 'Student Group',
  Assignment_Extra_User: 'Extra Users',
  Assignment_Exclude_User: 'Exclude Students',
  Assignment_Completion_Stats: 'Completion Stats',
  Assignment_Add_Problem: 'Add Problem',
  Assignment_Problem_Number: 'Problem ID',
  Assignment_Draft: 'Draft',
  Assignment_Published: 'Published',
  Assignment_Publish: 'Publish',
  Assignment_Save_Draft: 'Save Draft',
  Assignment_Save_Publish: 'Save & Publish',
  Assignment_Extend: 'Extend Deadline',
  Assignment_Accepted_Count: 'Accepted Count',
  Assignment_Finish_Time: 'Finish Time',
  Assignment_Delete_Tips: 'Are you sure you want to delete this assignment?',
  Assignment_Publish_Tips: 'Are you sure you want to publish this assignment?',
  Assignment_Extend_Tips: 'Please select a new deadline',
  Assignment_Time_Check: 'Start time must be earlier than end time',
  Assignment_Problem_Empty: 'Please add at least one problem',
  Assignment_No_Target: 'Please select at least one student group or enter a student',
  Assignment_Extra_User_Placeholder: 'Enter student username and press Enter',
  Assignment_Exclude_User_Placeholder: 'Select students to exclude',
  Student_Group_Name: 'Group Name',
  Student_Group_Description: 'Description',
  Student_Group_Member_Count: 'Members',
  Student_Group_Members: 'Member Management',
  Student_Group_Add: 'Add Student Group',
  Student_Group_Edit: 'Edit Student Group',
  Student_Group_Delete_Tips: 'Are you sure you want to delete this student group?',
  Student_Group_Add_Member: 'Add Member',
  Student_Group_Remove_Tips: 'Are you sure you want to remove this member?',
  Student_Group_Empty: 'No student group yet',
