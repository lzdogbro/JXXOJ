...
| 2025-07-01 | **新增 PK 对战功能**：1v1 实时编程对战，限时 20 分钟，积分排名系统   |             |
| 2025-07-01 | **新增私聊功能**：用户间一对一私信交流，联系人列表，未读消息提醒       |             |
...
<div align="center">
  <p><em>PK 对战进行中 — 左侧题目描述，右侧代码编辑器，顶部 20 分钟倒计时</em></p>
</div>

> PK 历史记录：查看个人所有对战记录，包括胜负详情和积分变化

<div align="center">
  <p><em>PK 对战历史 — 展示双方信息、题目、结果和积分变化</em></p>
</div>

### 14. 私聊系统（新增 🆕）

> 私聊界面：左侧联系人列表，右侧消息对话区，支持未读提醒

<div align="center">
  <p><em>私聊界面 — 联系人列表 + 消息对话，支持未读消息计数</em></p>
</div>
...
欢迎提交 Issue 和 Pull Request！如有任何问题，欢迎加入 QQ 群（598587305 或 743568562）讨论。
